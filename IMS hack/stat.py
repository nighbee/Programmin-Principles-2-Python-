...
class Trader:
    POSITION_LIMIT = 10  # The maximum absolute value of the position

    def run(self, state: TradingState):
        print("traderData: " + state.traderData)
        print("Observations: " + str(state.observations))
        result = {}
        buy_threshold = 10100  # Price threshold for buying
        sell_threshold = 9900  # Price threshold for selling
        ...
        if 'STARFRUIT' in state.order_depths:
            ...
            # Decide whether to buy or sell based on the buy_threshold, sell_threshold, and position limit
